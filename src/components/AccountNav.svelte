<script>
	...
	import { mainScreen, mainTarget, stackedScreen, currentScreen} from '../stores/account-context.js';
...
<nav>
	<div class="left">
		<button type="button" class={$currentScreen === 'Rewards' ? 'rewards selected' : 'rewards' } on:click={() => navigate(Rewards)}>
	...
	<div class="right">
		<button type="button" class={$currentScreen === 'Settings' ? 'settings selected' : 'settings' } on:click={(e) => { console.log(e); navigate(Settings)}}>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
