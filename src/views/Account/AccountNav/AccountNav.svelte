...
<nav>
	<div class="left">
		<button type="button" class:selected={$currentScreen === Achievements.name} on:click={() => navigate(Achievements)}>
	...
	<div class="right">
		<button type="button" class:selected={$currentScreen === Settings.name} on:click={() => navigate(Settings)}>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
